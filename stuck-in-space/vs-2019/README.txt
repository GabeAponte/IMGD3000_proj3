...
-gameX/              Source code for game.cpp and other game files
-gameX/cpp_files     Soucre code for all other .cpp game files
-gameX/header_files  Soucre code for all other header files
